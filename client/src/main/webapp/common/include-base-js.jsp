...
<script src="${ctx }/static/styles/bootstrap4/bootstrap.min.js"></script>
<script src="${ctx }/static/plugins/greensock/TweenMax.min.js"></script>
<script src="${ctx }/static/plugins/greensock/TimelineMax.min.js"></script>
<script src="${ctx }/static/plugins/scrollmagic/ScrollMagic.min.js"></script>
<script src="${ctx }/static/plugins/greensock/animation.gsap.min.js"></script>
<script src="${ctx }/static/plugins/greensock/ScrollToPlugin.min.js"></script>
<script src="${ctx }/static/plugins/OwlCarousel2-2.2.1/owl.carousel.js"></script>
<script src="${ctx }/static/plugins/Isotope/isotope.pkgd.min.js"></script>
<script src="${ctx }/static/plugins/easing/easing.js"></script>
