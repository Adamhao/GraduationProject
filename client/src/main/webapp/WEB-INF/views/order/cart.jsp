...
<div class="container">
                ...
                <c:otherwise>
                    ...
                    <c:forEach items="${sessionScope.cart}" var="cartItem">
                        ...
                        <tr pid="${ci.product.id}">
                            ...
                            <td><a style="height: 25px;width: 101px;color: #fff" class="btn btn-info delBtn btn-xs" productid="${ci.product.id}" onclick="del()">删除</a></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </c:otherwise>
    ...
    <div class="row">
        <div class="col-md-6 col-xs-9">
            <a style="height: 25px;width: 101px;" class="btn btn-info" href="${ctx}/product/">继续购买</a>
            <a style="height: 25px;width: 101px;color: #fff" class="btn btn-info" id="cleanCart" onclick="delAll()">清空购物车</a>
        </div>
        <div class="col-md-6 col-xs-3 text-right">
            <a style="height: 25px;width: 101px;" class="btn btn-primary" href="${ctx}/order/purchase/">结账</a>
        </div>
    </div>
</div>
...
<script>
    function del() {
        var num2 = parseInt(localStorage.getItem("cart"));
        console.log(num2);
        localStorage.setItem("cart",""+(num2-1));
        $("#cart").html("Cart("+(num2-1)+")");
    }
    function delAll(){
